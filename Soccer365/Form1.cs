...
namespace Soccer365
{
    public partial class Form1 : Form
    {
        ...
        void Btn_Soccer365_2_Click(object sender, EventArgs e)
        {
            int o = 12;
            int colTeam = 1;
                    ...
                    while (i < cmB_years_game.Items.Count)
                    {
                        ...
                        try
                        {
                            for (int y = 2; y < 21; y++)
                            {
                                ...
                                if (team.Total > 2.5)
                                {
                                    var fileName = $"C:\\Soccer\\КомандаТочно\\Тотал больше2.5.txt";
            ...
            try
            {
                string filename = $"C:\\Soccer\\КомандаТочно\\Тотал больше2.5.txt";
                ...
                while (i < kek.Count)
                {
                    ...
                    if (sSearch != "")
                    {
                        ...
                        if (counter > Convert.ToInt32(cmb_Occurs_more.Text))
                        {
                            ...
                            var fileName = $"C:\\Soccer\\КомандаТочно\\Тотал больше2.5_2.txt";
                            using (StreamWriter sw = new StreamWriter(fileName, true, Encoding.Unicode))
                            {
                                sw.Write($"{sSearch}\n");
                            }
                ...
                try
                {
                    string filename2 = $"C:\\Soccer\\КомандаТочно\\Тотал больше2.5_2.txt";
                    ...
                    var fileName = $"C:\\Soccer\\КомандаТочно\\Тотал больше2.5_3.txt";
                    using (StreamWriter sw = new StreamWriter(fileName, true, Encoding.Unicode))
                    {
                        sw.Write($"{dest}");
                    }
